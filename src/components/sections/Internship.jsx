            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto">
                    {experiences.map((exp, index) => (
                        <div key={index} className="bg-white dark:bg-slate-800 p-8 rounded-xl border-l-4 border-transparent bg-clip-padding relative shadow-sm hover:shadow-lg transition-all duration-300 group">
